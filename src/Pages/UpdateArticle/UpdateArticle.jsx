...
const UpdateArticle = () => {
  ...
  useEffect(() => {
    axios.get(`${import.meta.env.VITE_API_URL}/publishers`)
      .then(res => {
  ...
  // Load article data
  useEffect(() => {
    axios.get(`${import.meta.env.VITE_API_URL}/myarticles/${id}`) // changed route
      .then(res => {
        const data = res.data
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(`${import.meta.env.VITE_API_URL}/myarticles/${id}`, updatedData)
